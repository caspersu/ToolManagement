...
namespace Tool_Management.DataAccess
{
    ...
    public partial class ToolManagementEntities : DbContext
    {
        ...
        public virtual DbSet<vCNCKnifeList> vCNCKnifeLists { get; set; }
        public virtual DbSet<vProductionPlan> vProductionPlans { get; set; }
        public virtual DbSet<vEmpCNCKnifeList> vEmpCNCKnifeLists { get; set; }
        public virtual DbSet<KnifeUseLog> KnifeUseLogs { get; set; }
        public virtual DbSet<Inform> Informs { get; set; }
        public virtual DbSet<Outform> Outforms { get; set; }
        public virtual DbSet<vKnifeInForm> vKnifeInForms { get; set; }
